...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public static final int MSG_TYPE_LEFT2 = 2;
    public static final int MSG_TYPE_RIGHT2 = 3;
    ...
    public MessageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        else if (viewType == MSG_TYPE_LEFT2)
        {
    ...
    public int getItemViewType(int position) {
        ...
        if (!chat.getMessage().startsWith("https://firebasestorage.googleapis.com/")) {
            ...
            if (mChat.get(position).getSender().equals(fuser.getUid())) {
                return MSG_TYPE_RIGHT2;
            } else {
                return MSG_TYPE_LEFT2;
            }
        }
